...
EnmanApp.controller('CostController', ['$scope', 'AuthServices', '$state', 'FormMetaDataServices', 'alertServices',
	...
	$("#loadingWidget").fadeIn('slow');
        ...
        alertServices.get({"AlertType":"COST"}).then(function(responseData) {
