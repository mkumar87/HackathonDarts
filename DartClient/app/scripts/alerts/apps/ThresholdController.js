...
EnmanApp.controller('ThresholdController', ['$scope', 'AuthServices', '$state', 'FormMetaDataServices', 'alertServices',
	...
	$("#loadingWidget").fadeIn('slow');
        ...
        alertServices.get({"AlertType":"THRESHOLD"}).then(function(responseData) {
        ...
        $scope.thresholdAlertColumns = [{
            ...
            field: 'AlertFilterComparator'
        },{
            field: 'AlertFilterValue'
        }];
